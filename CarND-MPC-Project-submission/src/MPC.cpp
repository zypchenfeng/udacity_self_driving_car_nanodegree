 ...
 public:
  ...
  fg[0] = 0;
    ...
    for (unsigned int t = 0; t < N; t++) {
      fg[0] += 2000 * CppAD::pow(vars[cte_start + t] - ref_cte, 2); //3000
    ...
    for (unsigned int t = 0; t < N - 1; t++) {
      fg[0] += 50 * CppAD::pow(vars[delta_start + t], 2); // 5
    ...
    for (unsigned int t = 0; t < N - 2; t++) {
      fg[0] += 1500 * CppAD::pow(vars[delta_start + t + 1] - vars[delta_start + t], 2); // 200 
